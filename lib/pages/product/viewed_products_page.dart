...
class ViewedProductPage extends StatefulWidget {
  ...
  static final String id = "viewed_products_page";

  @override
  _ViewedProductPageState createState() => _ViewedProductPageState();
}

class _ViewedProductPageState extends State<ViewedProductPage> {

  // bu pageni cart containerni alohida widget qilasan va list qilib beriladigan qilib nomi bilan listni ham alohida list qil
